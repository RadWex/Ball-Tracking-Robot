...
#define ENCODER_REAR_LEFT_1 14	// left encoder
#define ENCODER_REAR_LEFT_2 15	// left encoder
#define ENCODER_REAR_RIGHT_1 17 // right encoder
#define ENCODER_REAR_RIGHT_2 16 // right encoder

/*
 * ultrasound modules are HC-SR04
*/
